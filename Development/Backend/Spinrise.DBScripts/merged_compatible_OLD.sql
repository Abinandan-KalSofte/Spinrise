...
IF OBJECT_ID('dbo.ksp_GetDatabases', 'P') IS NULL
    EXEC('CREATE PROCEDURE dbo.ksp_GetDatabases AS SET NOCOUNT ON')
GO
ALTER PROCEDURE dbo.ksp_GetDatabases
AS
BEGIN
    SET NOCOUNT ON;
...
IF OBJECT_ID('dbo.ksp_Auth_ValidateUser', 'P') IS NULL
    EXEC('CREATE PROCEDURE dbo.ksp_Auth_ValidateUser AS SET NOCOUNT ON')
GO
ALTER PROCEDURE dbo.ksp_Auth_ValidateUser
(
    @DivCode  VARCHAR(2),
...
IF OBJECT_ID('dbo.ksp_Auth_GetActiveDivisions', 'P') IS NULL
    EXEC('CREATE PROCEDURE dbo.ksp_Auth_GetActiveDivisions AS SET NOCOUNT ON')
GO
ALTER PROCEDURE dbo.ksp_Auth_GetActiveDivisions
AS
BEGIN
    SET NOCOUNT ON;
...
IF OBJECT_ID('dbo.ksp_Auth_GetUserById', 'P') IS NULL
    EXEC('CREATE PROCEDURE dbo.ksp_Auth_GetUserById AS SET NOCOUNT ON')
GO
ALTER PROCEDURE dbo.ksp_Auth_GetUserById
(
    @UserId  VARCHAR(100),
    @DivCode VARCHAR(2)
)
...
IF OBJECT_ID('dbo.ksp_PR_GetParameters', 'P') IS NULL
    EXEC('CREATE PROCEDURE dbo.ksp_PR_GetParameters AS SET NOCOUNT ON')
GO
ALTER PROCEDURE dbo.ksp_PR_GetParameters
(
    @DivCode VARCHAR(2)
)
AS
...
-- ksp_PR_PreAddChecks
IF OBJECT_ID('dbo.ksp_PR_PreAddChecks', 'P') IS NULL
    EXEC('CREATE PROCEDURE dbo.ksp_PR_PreAddChecks AS SET NOCOUNT ON')
GO
ALTER PROCEDURE dbo.ksp_PR_PreAddChecks
(
    @DivCode VARCHAR(2)
)
AS
...
IF OBJECT_ID('dbo.ksp_PR_GetDepartments', 'P') IS NULL
    EXEC('CREATE PROCEDURE dbo.ksp_PR_GetDepartments AS SET NOCOUNT ON')
GO
ALTER PROCEDURE dbo.ksp_PR_GetDepartments
(
    @DivCode   VARCHAR(2),
...
-- ksp_PR_GetEmployees
IF OBJECT_ID('dbo.ksp_PR_GetEmployees', 'P') IS NULL
    EXEC('CREATE PROCEDURE dbo.ksp_PR_GetEmployees AS SET NOCOUNT ON')
GO
ALTER PROCEDURE dbo.ksp_PR_GetEmployees
(
    @DivCode    VARCHAR(2),
    @EmpCommon  CHAR(1)     = 'N',
    @Search     VARCHAR(50) = NULL
...
-- ksp_PR_GetPrTypes
IF OBJECT_ID('dbo.ksp_PR_GetPrTypes', 'P') IS NULL
    EXEC('CREATE PROCEDURE dbo.ksp_PR_GetPrTypes AS SET NOCOUNT ON')
GO
ALTER PROCEDURE dbo.ksp_PR_GetPrTypes
(
    @ActiveOnly BIT = 1
)
AS
...
-- ksp_PR_GetItems
IF OBJECT_ID('dbo.ksp_PR_GetItems', 'P') IS NULL
    EXEC('CREATE PROCEDURE dbo.ksp_PR_GetItems AS SET NOCOUNT ON')
GO
ALTER PROCEDURE dbo.ksp_PR_GetItems
(
    @DivCode       VARCHAR(2),
    @Search        VARCHAR(50) = NULL,
...
IF OBJECT_ID('dbo.ksp_PR_GetItemDetail', 'P') IS NULL
    EXEC('CREATE PROCEDURE dbo.ksp_PR_GetItemDetail AS SET NOCOUNT ON')
GO
ALTER PROCEDURE dbo.ksp_PR_GetItemDetail
(
    @DivCode   VARCHAR(2),
    @ItemCode  VARCHAR(10),
    @FDate     DATE,
...
IF OBJECT_ID('dbo.ksp_PR_GetLastRecord', 'P') IS NULL
    EXEC('CREATE PROCEDURE dbo.ksp_PR_GetLastRecord AS SET NOCOUNT ON')
GO
ALTER PROCEDURE dbo.ksp_PR_GetLastRecord
(
    @DivCode VARCHAR(2),
    @FDate   DATE,
    @LDate   DATE
...
-- ksp_PR_GetById
IF OBJECT_ID('dbo.ksp_PR_GetById', 'P') IS NULL
    EXEC('CREATE PROCEDURE dbo.ksp_PR_GetById AS SET NOCOUNT ON')
GO
ALTER PROCEDURE dbo.ksp_PR_GetById
(
    @DivCode VARCHAR(2),
    @PrNo    NUMERIC(6,0),
    @PrDate  DATE = NULL
...
-- ksp_PR_GetList
IF OBJECT_ID('dbo.ksp_PR_GetList', 'P') IS NULL
    EXEC('CREATE PROCEDURE dbo.ksp_PR_GetList AS SET NOCOUNT ON')
GO
ALTER PROCEDURE dbo.ksp_PR_GetList
(
    @DivCode       VARCHAR(2),
    @FDate         DATE,
    @LDate         DATE,
...
-- ksp_PR_Save
IF OBJECT_ID('dbo.ksp_PR_Save', 'P') IS NULL
    EXEC('CREATE PROCEDURE dbo.ksp_PR_Save AS SET NOCOUNT ON')
GO
ALTER PROCEDURE dbo.ksp_PR_Save
(
    @Mode           VARCHAR(6),
    @DivCode        VARCHAR(2),
    @PrDate         DATE,
...
-- ksp_PR_Delete
IF OBJECT_ID('dbo.ksp_PR_Delete', 'P') IS NULL
    EXEC('CREATE PROCEDURE dbo.ksp_PR_Delete AS SET NOCOUNT ON')
GO
ALTER PROCEDURE dbo.ksp_PR_Delete
(
    @DivCode      VARCHAR(2),
    @PrNo         NUMERIC(6,0),
    @PrDate       DATE,
...
IF OBJECT_ID('dbo.ksp_PR_CheckPendingOrder', 'P') IS NULL
    EXEC('CREATE PROCEDURE dbo.ksp_PR_CheckPendingOrder AS SET NOCOUNT ON')
GO
ALTER PROCEDURE dbo.ksp_PR_CheckPendingOrder
(
    @DivCode  VARCHAR(2),
    @FDate    DATE,
    @LDate    DATE,
...
IF OBJECT_ID('dbo.ksp_PR_GetUserPermissions', 'P') IS NULL
    EXEC('CREATE PROCEDURE dbo.ksp_PR_GetUserPermissions AS SET NOCOUNT ON')
GO
ALTER PROCEDURE dbo.ksp_PR_GetUserPermissions
(
    @UserId  VARCHAR(50),
    @DivCode VARCHAR(2)
)
...
-- ============================================================
IF OBJECT_ID('dbo.ksp_PR_GetMachineLookup', 'P') IS NULL
    EXEC('CREATE PROCEDURE dbo.ksp_PR_GetMachineLookup AS SET NOCOUNT ON')
GO
ALTER PROCEDURE dbo.ksp_PR_GetMachineLookup
(
    @DivCode   VARCHAR(2),
    @DepCode   VARCHAR(10),
    @Search    VARCHAR(50) = NULL
...
-- ============================================================
IF OBJECT_ID('dbo.ksp_PR_GetCostCentreLookup', 'P') IS NULL
    EXEC('CREATE PROCEDURE dbo.ksp_PR_GetCostCentreLookup AS SET NOCOUNT ON')
GO
ALTER PROCEDURE dbo.ksp_PR_GetCostCentreLookup
(
    @DivCode   VARCHAR(2),
    @Search    VARCHAR(50) = NULL
)
...
-- ================================================================
IF OBJECT_ID('dbo.ksp_PR_GetPrint', 'P') IS NULL
    EXEC('CREATE PROCEDURE dbo.ksp_PR_GetPrint AS SET NOCOUNT ON')
GO
ALTER PROCEDURE dbo.ksp_PR_GetPrint
(
    @DivCode VARCHAR(2),
    @PrNo    NUMERIC(6,0),
    @PrDate  DATE = NULL
...
-- ============================================================
IF OBJECT_ID('dbo.ksp_PR_GetItemImagePath', 'P') IS NULL
    EXEC('CREATE PROCEDURE dbo.ksp_PR_GetItemImagePath AS SET NOCOUNT ON')
GO
ALTER PROCEDURE dbo.ksp_PR_GetItemImagePath
(
    @ItemCode VARCHAR(10)
)
AS
...
GO
IF OBJECT_ID('ksp_PR_GetOpenForForeclosure', 'P') IS NULL
    EXEC('CREATE PROCEDURE ksp_PR_GetOpenForForeclosure AS SET NOCOUNT ON')
GO
ALTER PROCEDURE ksp_PR_GetOpenForForeclosure
    @divcode      varchar(10),
    @fdate        date,
    @ldate        date,
...
GO
IF OBJECT_ID('ksp_PR_GetCancellablePRs', 'P') IS NULL
    EXEC('CREATE PROCEDURE ksp_PR_GetCancellablePRs AS SET NOCOUNT ON')
GO
ALTER PROCEDURE ksp_PR_GetCancellablePRs
    @divcode varchar(10),
    @yfdate  datetime,
    @yldate  datetime
AS
...
IF OBJECT_ID('ksp_PR_GetCancelledPRsForUndo', 'P') IS NULL
    EXEC('CREATE PROCEDURE ksp_PR_GetCancelledPRsForUndo AS SET NOCOUNT ON')
GO
ALTER PROCEDURE ksp_PR_GetCancelledPRsForUndo
    @divcode varchar(10),
    @yfdate  datetime,
    @yldate  datetime
AS
...
-- ============================================================
IF OBJECT_ID('dbo.ksp_PR_GetForCancellation', 'P') IS NULL
    EXEC('CREATE PROCEDURE dbo.ksp_PR_GetForCancellation AS SET NOCOUNT ON')
GO
ALTER PROCEDURE dbo.ksp_PR_GetForCancellation
(
    @DivCode    VARCHAR(2),
    @PrNo       NUMERIC(6,0),
    @PrDate     DATE,
...
-- ============================================================
IF OBJECT_ID('dbo.ksp_PR_Cancel', 'P') IS NULL
    EXEC('CREATE PROCEDURE dbo.ksp_PR_Cancel AS SET NOCOUNT ON')
GO
ALTER PROCEDURE dbo.ksp_PR_Cancel
(
    @DivCode      VARCHAR(2),
    @PrNo         NUMERIC(6,0),
    @PrDate       DATE,
...
-- ============================================================
IF OBJECT_ID('dbo.ksp_PR_UndoCancellation', 'P') IS NULL
    EXEC('CREATE PROCEDURE dbo.ksp_PR_UndoCancellation AS SET NOCOUNT ON')
GO
ALTER PROCEDURE dbo.ksp_PR_UndoCancellation
(
    @DivCode    VARCHAR(2),
    @PrNo       NUMERIC(6,0),
    @PrDate     DATE,
...
-- outer UnitOfWork transaction covering the full save batch.
-- ============================================================
IF OBJECT_ID('dbo.ksp_PR_SaveForeclosureLine', 'P') IS NULL
    EXEC('CREATE PROCEDURE dbo.ksp_PR_SaveForeclosureLine AS SET NOCOUNT ON')
GO
ALTER PROCEDURE dbo.ksp_PR_SaveForeclosureLine
(
    @DivCode   VARCHAR(2),
    @PrNo      NUMERIC(6,0),
    @PrDate    DATE,
...
IF OBJECT_ID('ksp_PR_GetPoParaForApproval', 'P') IS NULL
    EXEC('CREATE PROCEDURE ksp_PR_GetPoParaForApproval AS SET NOCOUNT ON')
GO
ALTER PROCEDURE ksp_PR_GetPoParaForApproval
    @DivCode VARCHAR(2)
AS
BEGIN
    SET NOCOUNT ON;
...
IF OBJECT_ID('ksp_PR_GetDeptForUser', 'P') IS NULL
    EXEC('CREATE PROCEDURE ksp_PR_GetDeptForUser AS SET NOCOUNT ON')
GO
ALTER PROCEDURE ksp_PR_GetDeptForUser
    @DivCode VARCHAR(2),
    @UserId  VARCHAR(6)
AS
BEGIN
...
IF OBJECT_ID('ksp_PR_GetFirstApprovalHeader', 'P') IS NULL
    EXEC('CREATE PROCEDURE ksp_PR_GetFirstApprovalHeader AS SET NOCOUNT ON')
GO
ALTER PROCEDURE ksp_PR_GetFirstApprovalHeader
    @DivCode VARCHAR(2),
    @PrNo    NUMERIC(6,0),
    @PrDate  DATETIME
AS
...
IF OBJECT_ID('ksp_PR_GetFirstApprovalLines', 'P') IS NULL
    EXEC('CREATE PROCEDURE ksp_PR_GetFirstApprovalLines AS SET NOCOUNT ON')
GO
ALTER PROCEDURE ksp_PR_GetFirstApprovalLines
    @DivCode VARCHAR(2),
    @PrNo    NUMERIC(6,0),
    @PrDate  DATETIME
AS
...
IF OBJECT_ID('ksp_PR_SaveFirstApproval', 'P') IS NULL
    EXEC('CREATE PROCEDURE ksp_PR_SaveFirstApproval AS SET NOCOUNT ON')
GO
ALTER PROCEDURE ksp_PR_SaveFirstApproval
    @DivCode   VARCHAR(2),
    @PrNo      NUMERIC(6,0),
    @PrDate    DATETIME,
    @AppDate   DATETIME,
...
IF OBJECT_ID('ksp_PR_DeleteFirstApproval', 'P') IS NULL
    EXEC('CREATE PROCEDURE ksp_PR_DeleteFirstApproval AS SET NOCOUNT ON')
GO
ALTER PROCEDURE ksp_PR_DeleteFirstApproval
    @DivCode   VARCHAR(2),
    @PrNo      NUMERIC(6,0),
    @PrDate    DATETIME,
    @UserId    VARCHAR(50),
...
BEGIN
    ...
    BEGIN TRY
        ...
        -- qtyreqd is the original requisition quantity — never null it on reversal
        UPDATE PO_PRL
        SET FirstAppQty  = 0,
            FirstApp     = NULL,
            prstatus     = NULL,
...
IF OBJECT_ID('ksp_PR_GetFirstApprovalReport', 'P') IS NULL
    EXEC('CREATE PROCEDURE ksp_PR_GetFirstApprovalReport AS SET NOCOUNT ON')
GO
ALTER PROCEDURE ksp_PR_GetFirstApprovalReport
    @DivCode VARCHAR(2),
    @PrNo    NUMERIC(6,0),
    @PrDate  DATETIME
AS
...
IF OBJECT_ID('ksp_PR_CheckUserApprovalLevel', 'P') IS NULL
    EXEC('CREATE PROCEDURE ksp_PR_CheckUserApprovalLevel AS SET NOCOUNT ON')
GO
ALTER PROCEDURE ksp_PR_CheckUserApprovalLevel
    @DivCode VARCHAR(2),
    @UserId  VARCHAR(50)
AS
BEGIN
...
IF OBJECT_ID('ksp_PR_GetPendingFirstApproval', 'P') IS NULL
    EXEC('CREATE PROCEDURE ksp_PR_GetPendingFirstApproval AS SET NOCOUNT ON')
GO
ALTER PROCEDURE ksp_PR_GetPendingFirstApproval
    @DivCode VARCHAR(2),
...
IF OBJECT_ID('ksp_PR_GetFirstApprovedForDeletion', 'P') IS NULL
    EXEC('CREATE PROCEDURE ksp_PR_GetFirstApprovedForDeletion AS SET NOCOUNT ON')
GO
ALTER PROCEDURE ksp_PR_GetFirstApprovedForDeletion
    @DivCode VARCHAR(2),
    @YFDate  DATETIME,         -- financial year start (B13/B14: year guard required)
    @YLDate  DATETIME          -- financial year end
AS
...
-- ============================================================
IF OBJECT_ID('dbo.ksp_Auth_GetCompanies', 'P') IS NULL
    EXEC('CREATE PROCEDURE dbo.ksp_Auth_GetCompanies AS SET NOCOUNT ON')
GO
ALTER PROCEDURE dbo.ksp_Auth_GetCompanies
AS
BEGIN
    SET NOCOUNT ON;
