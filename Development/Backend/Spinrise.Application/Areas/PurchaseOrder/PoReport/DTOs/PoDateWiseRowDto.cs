...
public class PoDateWiseRowDto
{
    ...
    // PO header order value (PO_ORDH.ORDVAL). The Date-Wise report's "Order Value" column
    // binds to this (once per PO); "Item Value" binds to LineValue (line PO_ORDL.ORDVAL).
