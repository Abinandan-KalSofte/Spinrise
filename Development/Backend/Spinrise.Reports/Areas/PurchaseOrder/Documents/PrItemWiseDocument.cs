...
public sealed class PrItemWiseDocument : IDocument
{
    ...
    private readonly IReadOnlyList<PrItemWiseRowDto> _rows;
    private readonly PrReportRequest _request;
    private readonly string _printName;
    private readonly string _unitName;

    public PrItemWiseDocument(IReadOnlyList<PrItemWiseRowDto> rows, PrReportRequest request)
    {
        _rows = rows;
        _request = request;
    ...
    private void ComposeContent(IContainer container)
    {
        ...
        container.Table(table =>
        {
            ...
            table.Header(h =>
            {
                ...
                HCell(h, ""); HCell(h, ""); HCell(h, ""); HCell(h, ""); HCell(h, ""); HCell(h, ""); HCell(h, "");
                // Line 2
    ...
    private static void RecordCell(TableDescriptor table, PrItemWiseRowDto r, bool withItemHeader)
    {
