...
public class DbAuthUserStore : IAuthUserStore
{
    ...
    public DbAuthUserStore(IUnitOfWork uow)
    {
        _uow = uow;
    }
    ...
    {
        var record = await _uow.Connection.QueryFirstOrDefaultAsync<PpPasswdRecord>(
    ...
    private static AuthUserDto MapToDto(PpPasswdRecord r) => new()
    {
        Id = 0,
