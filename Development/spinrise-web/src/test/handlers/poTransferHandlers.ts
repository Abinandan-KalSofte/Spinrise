...
const makePo = (poNo: number, poDate = '2026-06-09') => ({
  ...
  cgstPer: 9, sgstPer: 9, igstPer: 0, tcsPer: 0, discPer: 0,
  freightAmt: 0, packPer: 0, insurPer: 0, addTaxPer: 0, fileNo: '', fcaFob: 0,
  freightType: 'PAID', discApp: 'BEFORE', packApp: 'BEFORE',
